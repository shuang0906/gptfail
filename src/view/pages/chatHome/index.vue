<template>
  <div class="chatHome">
    <div class="chatLeft" style="width:20%; display:none;" v-show="showPersonist">
    ...
    <div class="chatLeft" style="display:none;" v-show="showSetupList">
      <!--openai.key input disabled
            ...
            <div v-show="SettingStatus == 3">
              ...
              <el-collapse-transition>
                <div v-show="showFineSetting">
                  <div class="block">
//here to put fine-tuning dataset
